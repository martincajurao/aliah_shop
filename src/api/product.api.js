...
export const  apiSearchProduct = (query, query2) => Axios.get(`${resource}-search/?search=${query}&category=${query2}`)
export const  apiDisplayByCategory = (query) => Axios.get(`${resource}-display-category/?category=${query}`)
